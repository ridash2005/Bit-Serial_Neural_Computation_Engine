...
REM
REM Generated by Vivado on Mon Dec 29 14:48:03 +0530 2025
...
echo "xvlog --incr --relax -L uvm -prj bitserial_nn_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj bitserial_nn_tb_vlog.prj -log xvlog.log
